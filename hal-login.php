...
<table align="center">
<tr>
  <td width="66">Username</td><td width="10">:</td><td width="312"><input type="text" class="input" size="50" name="user" /> *</td></tr>
<tr>
  <td width="66">Password</td><td width="10">:</td><td><input type="password" class="input" size="50" name="pass" /> *</td></tr>
<tr><td width="66"></td><td width="10"></td><td><input type="submit" class="submitButton" value="Masuk"/> <input type="reset" class="submitButton" value="Hapus"/></td></tr>
</table>
</form>
</div>
</div>
