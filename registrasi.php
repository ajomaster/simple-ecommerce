...
<tr><td width="100">Password</td><td width="20">:</td><td><input type="text" class="input" size="40" name="pass" /></td></tr>
...
<br /><br />
<div id="judul">Lihat-Lihat Produk Menarik Kami Yang Lainnya</div>
<?php
$q=mysql_query("select * from tbl_barang order by RAND() LIMIT 3");
...
?>
<br /><br /><p align="center">Ingin melihat semua koleksi produk kami...??? Silahkan cek ke : </p><div class="submitButton2">Produk Kami</div>
</div>
<div id="kanan">
