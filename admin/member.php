...
$no=$posisi+1;
$query=mysql_query("select * from tbl_member order by id_member DESC limit $posisi,$batas");
echo"<table style='border:1px dashed #333;' width='100%' border=1>";
echo"<tr><td>Nomor</td><td>Nama Pemesan</td><td>Username</td><td>Action</td></tr>";
while($r=mysql_fetch_array($query))
{
echo"<tr><td>$no</td><td>$r[nama]</td><td>$r[user]</td><td><a href='hapus-member.php?id_member=$r[id_member]'>Hapus Member</a></td></tr>";
$no++;
}
echo"</table>";
